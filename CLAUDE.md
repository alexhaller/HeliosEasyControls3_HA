...
- **pip-audit** domain for this project is `HeliosEasyControls3_HA`; required packages are `websockets` and `python-dateutil`.
- **Version** is managed by semantic-release; `feat` → minor, `fix` → patch.
- Brand assets live at `custom_components/HeliosEasyControls3_HA/brand/icon.png` and `brands/icon.png` (Helios red #C62828, 512×512 PNG).
